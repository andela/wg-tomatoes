...
class CacheKeyMapper(object):
    ...
    NUTRITIONAL_INFO_REPRESENTATION = 'nutritional-info-representation-{0}'
    ...
    def get_nutritional_info(self, param):
        '''
        Return the nutritional info representation
        '''
        return self.NUTRITIONAL_INFO_REPRESENTATION.format(self.get_pk(param))
